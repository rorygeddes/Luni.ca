      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6">
            <a href="https://instagram.com/luni.students" className="text-system-text-muted hover:text-system-accent transition-colors" target="_blank" rel="noopener noreferrer">
              <i className="fab fa-instagram text-xl"></i>
            </a>
            <a href="https://www.linkedin.com/in/rory-geddes/" className="text-system-text-muted hover:text-system-accent transition-colors" target="_blank" rel="noopener noreferrer">
