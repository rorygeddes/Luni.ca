...
const Home: React.FC = () => {
  return (
    <div className="min-h-screen bg-system-bg text-system-text">
          ...
          <div className="text-center">
            <div className="flex justify-center mb-8">
              <div className="relative">
                ...
                <div className="absolute -inset-2 bg-gradient-to-r from-system-deep-red/10 to-system-deep-red/5 rounded-full blur-lg"></div>
              </div>
            </div>
      ...
      <section id="features" className="py-20 px-4 sm:px-6 lg:px-8 bg-system-bg">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="bg-system-gold-light/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-system-accent/30">
              <div className="w-16 h-16 bg-gradient-to-r from-system-accent to-system-accent-light rounded-2xl flex items-center justify-center mb-6">
                <i className="fas fa-chart-line text-white text-2xl"></i>
              </div>
              <h3 className="text-2xl font-bold text-system-text mb-4">Real-Time Tracking</h3>
              <p className="text-system-text-muted leading-relaxed">
            ...
            {/* Feature 2 */}
            <div className="bg-system-gold-light/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-system-accent/30">
              <div className="w-16 h-16 bg-gradient-to-r from-system-accent-light to-system-accent rounded-2xl flex items-center justify-center mb-6">
                <i className="fas fa-piggy-bank text-white text-2xl"></i>
              </div>
              <h3 className="text-2xl font-bold text-system-text mb-4">Smart Savings</h3>
              <p className="text-system-text-muted leading-relaxed">
            ...
            <div className="bg-system-gold-light/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-system-accent/30">
              ...
              <h3 className="text-2xl font-bold text-system-text mb-4">Student-Focused</h3>
              <p className="text-system-text-muted leading-relaxed">
      ...
      {/* About Section */}
      <section id="about" className="py-20 px-4 sm:px-6 lg:px-8 bg-system-bg">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold text-system-text mb-6">
                Why <span className="bg-gradient-to-r from-system-accent to-system-accent-light bg-clip-text text-transparent">Luni</span>?
              </h2>
              <p className="text-xl text-system-text-muted mb-8 leading-relaxed">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  <div className="w-6 h-6 bg-gradient-to-r from-system-accent to-system-accent-light rounded-full flex items-center justify-center">
                    <i className="fas fa-check text-white text-sm"></i>
                  </div>
                  <span className="text-system-text-muted">Live spending tracking and notifications</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-6 h-6 bg-gradient-to-r from-system-accent to-system-accent-light rounded-full flex items-center justify-center">
                    <i className="fas fa-check text-white text-sm"></i>
                  </div>
                  <span className="text-system-text-muted">Personalized budgeting recommendations</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-6 h-6 bg-gradient-to-r from-system-accent to-system-accent-light rounded-full flex items-center justify-center">
                    <i className="fas fa-check text-white text-sm"></i>
                  </div>
                  <span className="text-system-text-muted">Student-specific features and insights</span>
                </div>
              </div>
            </div>
            <div className="relative">
              <div className="bg-gradient-to-br from-system-accent/20 to-system-accent-light/20 rounded-3xl p-8 backdrop-blur-sm">
                <div className="bg-system-gold-light/90 rounded-2xl p-6 shadow-xl border border-system-accent/30">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-lg font-semibold text-system-text">This Month</h3>
                    <span className="text-sm text-system-accent font-medium">+$150 saved</span>
                  </div>
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      <span className="text-system-text-muted">Food & Dining</span>
                      <span className="font-semibold text-system-text">$320</span>
                    </div>
                    <div className="w-full bg-system-gold-medium/30 rounded-full h-2">
                      <div className="bg-gradient-to-r from-system-accent to-system-accent-light h-2 rounded-full" style={{width: '64%'}}></div>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-system-text-muted">Transportation</span>
                      <span className="font-semibold text-system-text">$85</span>
                    </div>
                    <div className="w-full bg-system-gold-medium/30 rounded-full h-2">
                      <div className="bg-gradient-to-r from-system-accent-light to-system-accent h-2 rounded-full" style={{width: '34%'}}></div>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-system-accent to-system-accent-light">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link to="/survey" className="bg-white text-system-text px-8 py-4 rounded-full font-semibold hover:shadow-lg transition-all duration-300 transform hover:scale-105 flex items-center space-x-2">
